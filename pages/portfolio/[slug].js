            ...
            <div className={styles.contentInnerWrapper}>
                ...
                <div className={styles.columnsWrapper}>
                    <div className={styles.columnData}>
                        ...
                        {web && <a className={styles.gitAnchor} href={web.url} target="_blank">{web.label}</a>}
                        {github && <a className={styles.gitAnchor} href={github} target="_blank">Repositorio</a>}
                    </div>
                    <div className={styles.columnImages}>
                        {description}
                        {listImages && listImages.map((element, i) => <img className={styles.imageList} key={i} src={element} />)}
                    </div>
                </div>
            </div>
        </PageLayout>
